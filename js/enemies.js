...
Game.ENEMY_DEFS = {
  ...
  // 3面(無光王宮)の雑魚。最終面なので1面・2面とは共通化せず、高難度としてHP/弾速/密度を一段上げる。
  // 3種それぞれ別の撃ち方(ゆっくり回転するパルス/揺れる単発/噛みつき2連)で単調さを避ける。
  mediGrunt1: {
    ...
    shot: { interval: 2.2, ring: true, count: 5, speed: 70, radius: 4, rotStep: 0.35, color: "rgba(200, 160, 255, 0.9)", glowColor: "rgba(220, 190, 255, 0.4)" },
  },
  mediGrunt2: {
    ...
    radius: 14,
    score: Game.CONFIG.score.mediGrunt,
    shot: { interval: 1.3, speed: 140, radius: 4.5, waveAmp: 12, waveFreq: 2.0, color: "rgba(190, 230, 255, 0.95)", glowColor: "rgba(190, 230, 255, 0.42)" },
  },
  oriaGrunt: {
    ...
    // シャチらしい噛みつきの2連弾。3面は高難度として、2面より速く発射間隔も短めにする。

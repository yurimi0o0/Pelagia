...
Game.STAGE1 = {
  ...
  dialogue: {
    stageStart: [
      { speaker: "ジェリー", text: "最近の浅海は光がなく、みんな元気がない…。" },
      { speaker: "ジェリー", text: "でも大丈夫。海のいちばん深いところに、すべてを照らす光があるって。" },
      { speaker: "ジェリー", text: "「深海灯」。あれを持って帰れば、きっとこの海はまた明るくなる。" },
      { speaker: "ジェリー", text: "待っててね。わたしが、絶対に見つけてくるから。" },
    ],
  },
  phases: [
    {
